  ...
  return (
    <section className="relative overflow-hidden py-20 md:py-28">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center -mt-8 md:-mt-12">
        {subtitle && (
          <p className="font-script text-[#F7D711] text-2xl mb-3">{subtitle}</p>
        )}
        <h1 className="text-4xl md:text-6xl font-display font-extrabold text-white" style={{ textShadow: '0 2px 8px rgba(0,0,0,0.2)' }}>
          {title}
        </h1>
      </div>
    </section>
